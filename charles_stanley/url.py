...
def get_page_urls(driver: WebDriver, url: str, sheet: str) -> list[dict]:
    driver.get(url)
    if sheet == "ETF":
        table_name_xpath = '//*[@id="equity-table-first"]/tbody/tr'
        table_url_xpath = '//*[@id="equity-table-last"]/tbody/tr'
    else:
